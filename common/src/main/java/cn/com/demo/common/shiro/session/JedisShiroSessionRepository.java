package cn.com.demo.common.shiro.session;

import cn.com.demo.common.shiro.JedisManager;
import cn.com.demo.common.shiro.SerializeUtil;
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    ...
    public Session getSession(Serializable id) {
        ...
        try {
            byte[] tmp = SerializeUtil.serialize(buildRedisSessionKey(id));
            byte[] value = getJedisManager().getValueByKey(DB_INDEX, tmp);
